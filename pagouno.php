...
//        $this->smarty->assign(['payment_total' => number_format((float)Context::getContext()->cart->getOrderTotal(true)*0.95, 2, '.', '')]);
        ...
        $newOption->setModuleName($this->displayName)
            ->setCallToActionText($this->l('Tarjeta de Crédito o Débito'))
