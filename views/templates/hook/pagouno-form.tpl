<form method="post" action="{$action}">
    <script src="https://www.google.com/recaptcha/api.js?render=6LctAKUUAAAAAIp5_v-KTullaxMNAR6-lWD0Ubsi"></script>
    <div id="form-pagouno">
        ...
        <div class="pu-form-row">
            ...
            <select class="pagoUno-select" id="pagoUno_ccDocType" name="select" style="width: 100%">
        ...
        <div class="pu-form-row">
            <div class="pu-input pu-form-wide">
                ...
                <select class="pagoUno-select" id="pagoUno_dues" name="select" style="width: 100%">
